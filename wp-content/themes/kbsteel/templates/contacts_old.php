			...
			<div class="row no-gutters">
				<div class="faces col-12">
					...
					<div class="faces-left">
						<p><?php the_field( 'imya_sleva' ); ?></p>
						<a href="tel:<?php the_field( 'telefon_sleva' ); ?>" rel="nofollow" target="_blank"><?php the_field( 'telefon_sleva' ); ?></a>
						<br>
						<a href="mailto:<?php the_field( 'pochta_sleva' ); ?>" rel="nofollow" target="_blank"><?php the_field( 'pochta_sleva' ); ?></a>
					</div>
					<div class="faces-right">
						<p><?php the_field( 'imya_sprava' ); ?></p>
						<a href="tel:<?php the_field( 'telefon_sprava' ); ?>" rel="nofollow" target="_blank"><?php the_field( 'telefon_sprava' ); ?></a>
						<br>
						<a href="mailto:<?php the_field( 'pochta_sprava' ); ?>" rel="nofollow" target="_blank"><?php the_field( 'pochta_sprava' ); ?></a>
					</div>
				</div>
			</div>
			<div class="row no-gutters">
